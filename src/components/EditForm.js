...
const EditForm = () => {
  ...
  let { industry, companySize, headquarters, foundingYear, website } =
    ...
    let picture = contact?.picture ?? "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRUwVm7UV1DxZ-d7pwo96Moy4isTIAKOXrRvg&usqp=CAU";
  ...
  const {
    ...
    onSubmit: async (values, instance) => {
      ...
      let newObj ={};
      if(values.contact){
        newObj = { ...values, contact: {...values.contact, picture} };
      }
      else{
        newObj = { ...values};
      }
